...
# string.split('x')     Разбить по разделителю x в список подстрок
string_list = string.split(' ') # разбить по пробелу
print(string_list) # return ['Evgen', 'is', 'a', 'foggot']

# string.upper()        Преобр. в верхний регистр
# string.lower()        Преобр. в нижний регистр
